...
const Home = () => {
  ...
  return (
    ...
    <div className="wrapper">
      ...
      <Card img={Planner} title='Planner Structure' description='Inspired by accessiblity, we provide our users with the ability to bookmark their desired recipes for the times and days they would like to make them. With love, we aim to provide one of the most flexible and unique user experience.'/>
      </div>
    </div>
  );
};
