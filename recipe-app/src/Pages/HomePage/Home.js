...
const Home = () => {
  ...
  return (
    ...
    <div className="wrapper">
      <Card img={womanCooking} title='How to Use' description='Simply select the Profile page on the side menu and fill out your preferences, then navigate to the Recipes page to see what delicious meals we have put on your menu. '/>
